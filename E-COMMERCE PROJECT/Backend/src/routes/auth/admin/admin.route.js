...
const { registerAdmin, loginAdmin, fetchAllAdmin, forgotPassword, verifyOTP, newPassword, deleteAdmin, updateAdmin, activeOrInActiveAdmin, adminProfile, changePassword, fetchSingleAdmin, } = require('../../../controllers/auth/admin/admin.controller');
